...
export default function RelatoriosPage(): JSX.Element {
  ...
  // LAYOUT NOVO (SEM SIDEBAR / SEM NAVBAR) ---------------------------------------------------------------
  return (
    <div className="flex flex-col bg-gradient-to-br from-[#0e0e0e] via-[#1a1a1a] to-black min-h-screen text-white">

      <div className="px-6 py-6 max-w-7xl mx-auto w-full pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              {/* XP */}
              <div className="bg-[#1b1b1b] p-4 rounded-xl border border-gray-800 shadow-lg flex items-center gap-4">
              ...
              <div className="bg-[#1b1b1b] p-4 rounded-xl border border-gray-800 shadow-lg flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-white">
                    {overview?.missionsCompleted ?? completedMissions}
                  </div>
              ...
              <div className="bg-[#1b1b1b] p-4 rounded-xl border border-gray-800 shadow-lg flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-white">
                    {overview?.daysActive ?? consistency?.totalDays ?? "—"}
                  </div>
              ...
              <div className="space-y-3 text-gray-300 text-sm">
                ...
                <div>
                  ...
                  <div className="text-white font-medium mt-1">
                    {formatDateShort(
                      missions.find((m) => m.completed)?.completedAt
                    )}
                  </div>
                </div>
              </div>
