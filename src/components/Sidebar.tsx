...
const Sidebar: React.FC<{ onToggle?: (collapsed: boolean) => void }> = ({ onToggle }) => {
  ...
  useEffect(() => {
    ...
    // não adicionar setIsCollapsed nas deps
  }, [location.pathname]);
  ...
  const variants = {
    expanded: { width: 256 }, // w-64
    collapsed: { width: 80 }, // w-20
  };
...
${isHome ? "top-16 left-0" : "top-0 left-0"}
        ${isHome ? "z-40" : "z-10"}
      `}
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          {/* Logo / título */}
          {!isCollapsed ? (
            <div className="flex items-center gap-3 cursor-default select-none" aria-hidden>
                    ...
                    className={`
                      ...
                      ${
                        active
                          ...
                          : "text-gray-300 hover:text-yellow-400 hover:bg-yellow-400/6"
                      }
